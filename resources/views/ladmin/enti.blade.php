            ...
            <div class="page-container">
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">SELLER</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ url ('/adduser') }}">
                                            ...
                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="email">Middle Name (optional):</label>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="Role">Citizenship:</label>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    ...
                                                                    <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name"  placeholder="+1 " autocomplete="name" autofocus>
                         ...
                         <div>
                            <h4 style="margin-top:30px; margin-bottom:30px;">Residential Address</h4>
</div>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="email">Street Address 1:</label>
                                                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="email" autofocus>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">Street Address 2 (optional):</label>
                                                                    <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name"  autocomplete="name" autofocus>
                                                                    ...
                                                                    @enderror
                                                                     ...
                                                                     <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">City</label>
                                                                    <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name"  autocomplete="name" autofocus>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="email">Region:</label>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">Postal Code:</label>
                                                                    <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name"  autocomplete="name" autofocus>
...
<h4 style="margin-top:20px; margin-bottom:30px;">Proof of Identity</h4>
                                         

                                         <div class="form-row">
                                                                 <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">Date of Birth:</label>
                                                                    <input id="name" type="Date" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="e.g Google" autocomplete="name" autofocus>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="email">Passport Number:</label>
                                                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="email" autofocus>
                                                                 ...
                                                                 <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="Role">ID Type:</label>
                                                                    <select name="role" class="form-control" >
                                                                  
                                                                      <option value="Driver-License">Driver's License</option>
                                                                      <option value="Passport">Passport & Proof of Address</option>
                                                                      <option value="Government-ID">Government-Issued ID</option>
                                                                       </select>
                                                                </div>

                                                                     <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">Expiration Date:</label>
                                                                    <input id="name" type="date" class="form-control @error('name') is-invalid @enderror" name="name"  autocomplete="name" autofocus>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="email">Passport:</label>

                                                                    <input id="name" type="file" class="form-control @error('name') is-invalid @enderror" name="name"   autofocus>
 
                                                                 </div>

                                                                 <div class="form-group col-md-4">
                                                                    <label class="font-weight-semibold" for="userName">Proof of Address:</label>
                                                                    <input id="name" type="file" class="form-control @error('name') is-invalid @enderror" name="name"   autofocus>
