...
<nav class="breadcrumb breadcrumb-dash">
                                                <a href="/ldashboard" class="breadcrumb-item">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-lg-4 text-right">
                        <a class="btn btn-primary" href="{{url('/lcreateuser')}}">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="font-size-12"><a href="{{url('/',$data->id)}}">{{$data->email}}</a></span>
                                    </td>

                                    <td>

                                        <p class="m-b-0 font-size-13">{{$data->role}}</p>
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-success m-r-5" href="{{url('/approve',$data->id)}}">Activate</a>
                                    <a class="btn btn-danger m-r-5" href="{{url('/deny',$data->id)}}">Deactivate</a>
                                    </td>
                                </tr>
                            </tbody>
